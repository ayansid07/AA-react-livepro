...
export default function Signup() {
  ...
  return (
    <div>
      <h2 className="text-5xl text-green-600 m-6 font-bold mb-6 text-gray-800">
        Sign Up
      </h2>
      ...
      <div className="w-full h-full flex items-center justify-center mb-28">
        <div
          ...
          style={{
            backgroundImage:
              'url("https://img.freepik.com/premium-photo/green-watercolor-background-with-stain-watercolor_900101-24012.jpg")',
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          <form
            className="max-w-md w-full bg-white bg-opacity-50 rounded-3xl p-8 shadow-2xl backdrop-blur-lg"
          ...
          >
            ...
            <div className="mb-4 flex items-center">
              <label
                htmlFor="profilePic"
                className="block text-gray-700 text-lg font-bold mb-2 mr-10"
              >
                Profile Image
              </label>
              <label
                htmlFor="profilePic"
                className="w-1/2 h-12 flex items-center justify-center bg-green-500 text-white rounded-3xl cursor-pointer"
              >
